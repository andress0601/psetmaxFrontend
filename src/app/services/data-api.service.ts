...
export class DataApiService {
  ...
  getAllProducts(){ 
    const url_api = 'https://psetmax.herokuapp.com/api/productos';
  ...
  getIdUserProducts(){ 
    ...
    const url_api = `https://psetmax.herokuapp.com/api/productos?filter[where][identifacorusuario]=${iduser}`;
  ...
  getProductById(id:string){
    const url_api = `https://psetmax.herokuapp.com/api/productos/${id}`;
    return (this.product = this.http.get(url_api));
  }
  
  saveProduct(product: ProductInterface){
    const token = this.authService.getToken();
    const url_api = `https://psetmax.herokuapp.com/api/productos?access_token=${token}`;
  ...
  updateProduct(product){
    ...
    const token = this.authService.getToken();
    const url_api = `https://psetmax.herokuapp.com/api/productos/${productId}/?access_token=${token}`;
  ...
  deleteProduct(id: string){
    const token = this.authService.getToken();
    const url_api = `https://psetmax.herokuapp.com/api/productos/${id}/?access_token=${token}`;
  ...
  getAllTemBuys(){ 
    const url_api = 'https://psetmax.herokuapp.com/api/tempbuys';
    return this.http.get(url_api);
  }
  ...
  getIdUserBuys(){ 
    ...
    const url_api = `https://psetmax.herokuapp.com/api/tempbuys?filter[where][iduser]=${iduser}`;        
    return this.http.get(url_api);
  }

  deleteBuy(id: string){
    const token = this.authService.getToken();
    const url_api = `https://psetmax.herokuapp.com/api/tempbuys/${id}/?access_token=${token}`;
  ...
  saveBuy(buy: BuysInterface){
    const token = this.authService.getToken();
    const url_api = `https://psetmax.herokuapp.com/api/tempbuys?access_token=${token}`;
